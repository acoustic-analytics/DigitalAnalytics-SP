...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "DAMod",
            url: "https://github.com/acoustic-analytics/DigitalAnalytics/releases/download/1.1.93/DAMod_XCFramework_Release.zip",
            checksum: "40c55a52a8deca85b36e235af0cc341623a57d34fabda1f27d960ec019304260"),
        .binaryTarget(
            name: "EOCore",
